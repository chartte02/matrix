...
public:
    ...
    void matrix_modify_name(string na);//修改名称 
    matrix matrix_intercept_row(const matrix&m,int r1,int r2);//行截取 
    matrix matrix_intercept_col(const matrix&m,int c1,int c2);//列截取 
    matrix matrix_intercept_dia(const matrix &m,int d);//对角截取 
    void matrix_modify();
